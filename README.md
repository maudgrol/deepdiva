...
To make a model prediction based on an input sound (.wav file) with our currently best performing model, run:

```angular2html
python src/deepdiva/model/model_prediction.py --audio-path "./data/dataset_11params/audio" --audio-file "eval_0_audio_22.wav" 
```
The folder 'dataset_11params/audio' contains 50 test sounds.
...
Please note that this requires you to have the DIVA software synthesizer installed on your computer.
